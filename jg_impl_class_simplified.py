...
class OxygenCascadeSimplified:
    ...
    def updatebloodgascontents(self):
        ...
        self.content['CvCO2'] = self.AGE['CvCO2']
        self.content['CvO2'] = self.AGE['CvO2']
        self.content['CcCO2'] = self.AGE['CcCO2']
        self.content['CcO2'] = self.AGE['CcO2']
